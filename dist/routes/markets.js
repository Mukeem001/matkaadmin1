...
router.get("/markets/:id", userAuthMiddleware, async (req, res) => {
...
router.put("/markets/:id", authMiddleware, async (req, res) => {
...
router.delete("/markets/:id", authMiddleware, async (req, res) => {
